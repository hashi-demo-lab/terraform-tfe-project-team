...
- **Example**: `hashi-demos-apj` or `my-company`
...
TFE_ORG="hashi-demos-apj"           # Your TFC organization
...
```
hashi-demos-apj/project-team/tfe
```

**Registry URL will be**:
```
https://app.terraform.io/app/hashi-demos-apj/registry/modules/private/hashi-demos-apj/project-team/tfe
```
...
3. Add each variable:
   ...
   **Variable 1:**
   - Name: `TFE_ORG`
   - Value: `hashi-demos-apj` (or your org)
   - Click **Add variable**
...
| TFE Project | `hashi-demos-apj` | `project-team` | `tfe` | `hashi-demos-apj/project-team/tfe` |
...
| Variable | `TFE_ORG` | `hashi-demos-apj` | Settings → Variables |
