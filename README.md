...
| <a name="output_details"></a> [details](#output\_details) | Comprehensive details of the TFE project and its configurations |
...
| <a name="output_project_name"></a> [project\_name](#output\_project\_name) | The name of the TFE project |
| <a name="output_team"></a> [team](#output\_team) | TFE teams with pre-defined RBAC roles |
